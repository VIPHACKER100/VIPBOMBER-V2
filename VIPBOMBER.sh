...
banner() {
    ...
    echo -e "\e[4;32m   YouTube: https://www.youtube.com/@VIPHACKER100 \e[0m"
    echo " "
    echo "NOTE: Kindly move to the PIP version Of VIPBOMBER-V2 for more stability."
    echo " "
}
...
if [ -f .update ];then
    ...
    echo .
    install_deps
    echo This Script Was Made By VIPBOMBER-V2 > .update
