...
banner() {
    ...
    echo " "
    echo "NOTE: Kindly move to the PIP version Of VIPHACKER100 for more stability."
    echo " "
}
...
if [ -f .update ];then
    ...
    echo .
    install_deps
    echo This Script Was Made By VIPHACKER100 > .update
